                            ...
                            <nav class="top-header-menu">
                                <ul class="list-inline">
                                    <?php if ($this->session->userdata('user_type')) { ?>
                                        <li><a href="<?= site_url('editCart'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="sumOfItems"><?php if(get_cookie('total')){ echo get_cookie('total'); }else{ echo '0'; } ?></span> <!--<span class="caret"></span>--></a>
