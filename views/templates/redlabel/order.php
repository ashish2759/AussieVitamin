...
<!--                    <section class="a-SpeedyReordering col-md-12">-->
                        ...
                        <table class="shopping-cart-product table">
                            ...
                            <tbody>
                                ...
                                foreach ($order_data as $row) :
                                    ...
                                    <tr class="removeme<?= $j; ?>">
                                        <td width="10%"><?php echo $j + 1; ?></td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-8"> <?= $row['manufacturer']; ?>, <?= $row['title']; ?></div>
                                                <?php
                                                foreach ($imageall as $image_row):
                                        ...
                                        <td style="text-align: center;" width="10%"><?= $row['order_quantity']; ?></td>
                                        <td style="text-align: center;" width="10%"><?= $row['price']; ?></td>
        ...
        <!--        <span class="" style="text-align: right;"><span id="Grandtotal"><?php if (get_cookie('coupon_total')) {
                                    echo '$ ' . get_cookie('coupon_total');
                                    ?><?php } else { ?>$ <?= $total; ?><?php } ?></span></span>-->
                        <!--      </p>-->
                        <!--    </div>-->
                        <!--  </div>-->
                        <!--</div>-->
