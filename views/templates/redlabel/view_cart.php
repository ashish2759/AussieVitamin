...
//			pr(count($products),0);
//			
//			pr(get_cookie('total'),0);
//			pr(get_cookie('count_cart'),0);
//			pr($_COOKIE,0);
/*
Array
(
    [PHPSESSID] => fht21q8u8ird1sa95n8c533ka1
    [ci_session] => hh7s034c2t5kua0paegq5v6eq4mntgsu
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="cart-order-summary">
                        <p>
                          <span style="font-size: 14px; font-weight: bold; float: left;width: 60%;">Sub Total:</span>
                          <span class="" style="text-align: left;width: 40%;">$ <?= $total; ?></span>
                        </p>
                        <p>
                          <span style="font-size: 14px; font-weight: bold; float: left; width: 60%">Coupon Amount:</span>
                          <span class="" style=" width: 40%; text-align: left;">
	                          <span id="coupon_amount" style="width:100%;">
	                          	<?php if(get_cookie('coupon')){ echo '$ '.get_cookie('coupon'); ?><?php }else{ ?>$ <?= '0.00'; ?><?php } ?>
	                          </span>
                          </span>
                          </p>
                        <p>
                          <span style="font-size: 14px; font-weight: bold; float: left;width: 60%"><strong>Grand Total:</strong></span>                                   
                          <span class="" style="text-align: left;width: 40%;"><span id="Grandtotal" style="width: 100%;"><?php if(get_cookie('coupon_total')){ echo '$ '.get_cookie('coupon_total'); ?><?php }else{ ?>$ <?= $total; ?><?php } ?></span></span>
                        </p>
                        <p>
