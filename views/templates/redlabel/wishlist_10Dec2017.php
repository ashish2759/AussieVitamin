                                		...
                                		<tbody>
                                			<?php foreach($products as $row) : ?>
                                		     <tr>
                                				...
                                				<td><?= $row['price']; ?> </td>
                                				<td> 
                                					<a href="<?php echo site_url('editCart/set?ip=').$row['product_id'].'&qty=1'; ?>" data-toggle="tooltip" title="Add to cart this product" data-placement="bottom" style="padding-right:10px;"><span class="fa fa-shopping-cart"></span></a>
