                    ...
                    foreach ($orders as $tr) {
                        ...
                        <tr>
                            ...
                            <td class="<?= $class ?> text-center" data-action-id="<?= $tr['id'] ?>">
                                ...
                                <!---<div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 1)" class="btn btn-default btn-xs">Ordered</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 2)" class="btn btn-primary btn-xs">Shipped</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 3)" class="btn btn-info btn-xs">Processed</a></div>
                                ...
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 0)" class="btn btn-danger btn-xs">Closed</a></div>
                                <div style="margin-bottom:4px;"><a href="javascript:void(0);" onclick="changeOrdersOrderStatus(<?= $tr['id'] ?>, 5)" class="btn btn-warning btn-xs">Refunded</a></div>--->
                                <a href="#" class="btn btn-default more-info" data-toggle="modal" data-target="#<?= $tr['order_id'] ?>edit" style="margin-top:10%;" data-more-info="<?= $tr['order_id'] ?>">
                                    Change
                                </a>
								
								
								
                                <a href="#" class="btn btn-default more-info" data-toggle="modal" data-target="#<?= $tr['order_id'] ?>TrackingNumber" style="margin-top:10%;" data-more-info="<?= $tr['order_id'] ?>">
                                    <?php if(empty($tr['TrackingNumber'])){ ?>
									Tracking Number
									<?php }else echo 'Edit: '.$tr['TrackingNumber'];?>
                                </a>
								
								
                                
                            </td>
                            <div class="modal fade" id="<?= $tr['order_id'] ?>edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				    <div class="modal-dialog" role="document">
				        <div class="modal-content">
				            <div class="modal-header">
				                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				                <h4 class="modal-title" id="myModalLabel">Chage Order Status</h4>
				            </div>
				            <div class="modal-body" >

            
				            <form action="<?= base_url('admin/ecommerce/orders/change_status_mail') ?>" method="POST" >
				            
				            <input type="hidden" name="order_id" value="<?= $tr['id'] ?>" >
				            
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '1') { ?> checked="checked" <?php } ?>  value="1"> Ordered&nbsp;&nbsp;&nbsp;
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '2') { ?> checked="checked" <?php } ?>  value="2"> Shipped&nbsp;&nbsp;&nbsp;
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '3') { ?> checked="checked" <?php } ?>  value="3"> Processed&nbsp;&nbsp;&nbsp;
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '4') { ?> checked="checked" <?php } ?>  value="4"> Delivered&nbsp;&nbsp;&nbsp;
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '0') { ?> checked="checked" <?php } ?>  value="0"> Closed&nbsp;&nbsp;&nbsp;
				            <input type="radio" name="order_status" <?php if ($tr['processed'] == '5') { ?> checked="checked" <?php } ?>  value="5"> Refunded&nbsp;&nbsp;&nbsp;
				            <br>
				            <textarea name="status_details" class="form-control" placeholder="Enter Detilas"><?= $tr['status_info'] ?></textarea>
                            ...
                            <div class="modal fade" id="<?= $tr['order_id'] ?>TrackingNumber" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				    <div class="modal-dialog" role="document">
				        <div class="modal-content">
				            <div class="modal-header">
				                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				            ...
				            <form action="<?= base_url('admin/ecommerce/orders/EditTrackingNumber') ?>" method="POST" >
				            
				            <input type="hidden" name="order_id" value="<?= $tr['id'] ?>" >
				            
				             
				            <br>
				<input type="text" name="TrackingNumber" id="TrackingNumber" class="form-control" placeholder="Enter Tracking Number" value="<?= $tr['TrackingNumber'] ?>">
				            <div class="modal-footer">
				            	<button type="submit" class="btn btn-default">Submit</button>
				                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				            </div>
