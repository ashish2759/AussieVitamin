...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <div class="form-group"> 
        ...
        <select name="manufacturer" value="" class="form-control">
    ...
    if (!empty($manufacturers)) {
        ?>
            ...
            <?php } ?>
            <?php }else{ ?>
               <option value="">Manufacturer not found!</option>
            <?php } ?>
        </select>
    </div>
    ...
    <?php } foreach ($languages->result() as $language) { ?>
        <div class="form-group"> 
            ...
            <input type="text" name="title[]" value="<?= $trans_load != null && isset($trans_load[$language->abbr]['title']) ? $trans_load[$language->abbr]['title'] : '' ?>" class="form-control" placeholder="Enter Product Title">
        </div>
        <?php
    } $i = 0;
    ?>
    <div class="form-group"> 
        ...
        <input type="text" name="product_code" value="" class="form-control" placeholder="Enter Product Code">
    </div>
    <div class="form-group">
        <label>Expiration Date</label>
        <input type="text" name="expiration_date" value="" class="form-control" placeholder="Enter Expiration Date">
    </div>
     <div class="form-group"> 
        <label>UPC Code</label>
        <input type="text" name="upc_code" value="" class="form-control" placeholder="Enter UPC Code">
    </div>

<div class="form-group"> 
        <label>IHerb URL</label>
        <input type="text" name="source_url" value="" class="form-control" placeholder="IHerb URL"> 
    </div>
    <div class="form-group">
    ...
    foreach ($languages->result() as $language) {
        ?>
        <div class="form-group">
            <label for="description<?= $i ?>">Description (Left Side)</label>
    ...
    foreach ($languages->result() as $language) {
        ?>
        <div class="form-group">
            <label for="description<?= $i ?>">Description (Right Side)</label>
            <textarea name="description_r[]" id="description_r<?= $i ?>" rows="50" class="form-control"></textarea>
            <script>
                CKEDITOR.replace('description_r<?= $i ?>');
            </script>
        </div>
        <?php
        $i++;
    ...
    foreach ($languages->result() as $language) {
        ...
        <div class="form-group for-shop">
            ...
            <input type="text" name="cost_price[]" placeholder="without currency at the end" value="<?= $trans_load != null && isset($trans_load[$language->abbr]['cost_price']) ? $trans_load[$language->abbr]['cost_price'] : '' ?>" class="form-control">
        </div>
            <label>Price</label>
    ...
    <div class="form-group for-shop">
        ...
        <input type="text" placeholder="Package Quantity" name="package_qty" value="<?= @$_POST['package_qty'] ?>" class="form-control" id="package_qty">
    </div>
    <?php if ($showBrands == 1) { ?>
        <div class="form-group for-shop">
            <label>Brand</label>
    ...
    <div class="form-group for-shop">
        ...
        <input type="text" placeholder="Enter Dimensions" name="dimension" value="" class="form-control">
    </div>
    <div class="form-group for-shop">
        <label>Weight</label>
        <input type="text" placeholder="Enter Weight" name="weight" value="" class="form-control">
    </div>
    <div class="form-group for-shop">
        <label>Trending Check to display on front end</label><br>
