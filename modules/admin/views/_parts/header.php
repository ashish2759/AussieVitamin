                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li><a href="<?= base_url('admin/manufacture') ?>" <?= urldecode(uri_string()) == 'admin/manufacture' ? 'class="active"' : '' ?>><i class="fa fa-list-alt" aria-hidden="true"></i> Manufacturer </a></li>
                                    ...
                                    <li><a href="<?= base_url('admin/products') ?>" <?= urldecode(uri_string()) == 'admin/products' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> All product</a></li>
                                    <?php if ($showBrands == 1) { ?>
                                    ...
                                    <li><a href="<?= base_url('admin/staffusers') ?>" <?= urldecode(uri_string()) == 'admin/staffusers' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Staff Users</a></li>
                                    <li><a href="<?= base_url('admin/customers') ?>" <?= urldecode(uri_string()) == 'admin/customers' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Customers</a></li>
