...
class Publish extends ADMIN_Controller
{
    ...
    public function index($id = 0)
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            unset($_POST['translations'], $_POST['title'], $_POST['basic_description'], $_POST['description'], $_POST['price'], $_POST['cost_price'], $_POST['old_price'], $_POST['manufacturer'], $_POST['description_r'], $_POST['product_code'], $_POST['upc_code'], $_POST['source_url'], $_POST['expiration_date'], $_POST['dimension'], $_POST['weight'], $_POST['package_qty']); //remove for product
