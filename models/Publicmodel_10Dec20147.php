...
class Publicmodel extends CI_Model
{
    ...
    function get_wishlist_product($data){
        ...
        $result = $this->db->select('wishlist_products.wishlist_id, wishlist_products.product_id, translations.title, translations.price, translations.old_price, products.image')->get_where('wishlist_products', $data);
        return $result->result_array();
    }
