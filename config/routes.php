...
$route['registration/(:num)'] = "registration/index/$1";
...
// Brand page
$route['shopping-cart/brand'] = "brands/index/$1";

// Brand page
$route['shopping-cart/category'] = "categories/index/$1";

// BrandAZ page
$route['shopping-cart/brandsaz'] = "brandsAZ/index/$1";

// itemLists page
$route['shopping-cart/itemlists'] = "itemLists/index/$3";

// View cart page
$route['shopping-cart/viewcart'] = "EditCart/index";


// Buyer page
$route['shopping-cart/buyer'] = "Buyer/index";

// Help page
$route['shopping-cart/help'] = "Help/index";

// About page
$route['shopping-cart/about'] = "About/index";

// Contact us page
$route['shopping-cart/contact_us'] = "Contact_us/index";
...
$route['admin/manufacture'] = "admin/ecommerce/manufacture";
...
$route['admin/staffusers'] = "admin/advanced_settings/staffusers";
$route['admin/customers'] = "admin/advanced_settings/customers";
$route['admin/staffusers/add_staff_members'] = "admin/advanced_settings/staffusers/add_staff_members";
// TEXTUAL PAGES
